...
ansible-deploy:
	...
	ansible-playbook -i infrastructure/backend/development/ansible/inventory/inventory.ini infrastructure/backend/development/ansible/all.yml -u root -t replace-nginx
